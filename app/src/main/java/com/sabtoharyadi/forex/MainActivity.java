package com.sabtoharyadi.forex;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initForex() {
        ...
        String url = "https://openexchangerates.org/api/latest.json?app_id=6628ee436ddb4644a469fe3f087915e7";
        ...
        asyncHttpClient.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                hkdTextView.setText(formatNumber(gbp, "###,##0.##"));
                inrTextView.setText(formatNumber(hkd, "###,##0.##"));
                jpyTextView.setText(formatNumber(inr, "###,##0.##"));
                myrTextView.setText(formatNumber(jpy, "###,##0.##"));
